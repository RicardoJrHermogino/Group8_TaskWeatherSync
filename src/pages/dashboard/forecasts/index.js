...
export default function Forecasts() {
  ...
  return (
    <>
      ...
      <CssBaseline />
      <Container>
        <Grid container mb={10} spacing={3} style={gradientStyle} textAlign={'center'}>
          <Grid item xs={6}>
          ...
          <Grid item xs={12}>
            <Typography variant="body2" sx={{minWidth:'20%', border: '1px solid black', borderRadius:'20px', }}> {CITY} City</Typography>
          </Grid>
